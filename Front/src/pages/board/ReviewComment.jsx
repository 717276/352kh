...
import '../../components/css/board/ReviewComment.css';
...
const ReviewComment = () => {
  ...
  useEffect(() => {
    const reviewUrl = `http://localhost:8080/api/reviewComment/${ar_no}`;
    ...
    <>
      ...
      <div className="comment-container">
        ...
        <div className="modifyButton">
          {isUserAllowedToEdit && (
            <button id="modifyButton" onClick={() => nav(`/board/review/modify/${ar_no}`)}>수정</button>
          )}
          <button id="cancelButton" onClick={() => nav('/board/review')}>취소</button>
        </div>
      </div>
